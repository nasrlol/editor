...
#if ASAN_ENABLED
C_LINKAGE void
__asan_poison_memory_region(void const volatile *Address, size_t Size);
C_LINKAGE void
__asan_unpoison_memory_region(void const volatile *Address, size_t Size);
