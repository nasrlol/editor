...
LinuxReturnStringForSymbol(KeySym Symbol)
{
    switch(Symbol)
    {
        ...
        case XK_dead_aboveverticalline:
            return "dead_aboveverticalline";
            break;
        case XK_dead_belowverticalline:
            return "dead_belowverticalline";
            break;
        case XK_dead_longsolidusoverlay:
            return "dead_longsolidusoverlay";
            break;
        case XK_dead_a:
            return "dead_a";
            break;
        ...
        case XK_Prev_Virtual_Screen:
            return "Prev_Virtual_Screen";
            break;
        case XK_Next_Virtual_Screen:
            return "Next_Virtual_Screen";
            break;
        case XK_Last_Virtual_Screen:
            return "Last_Virtual_Screen";
            break;
        ...
        case XK_3270_Duplicate:
            return "3270_Duplicate";
            break;
        case XK_3270_FieldMark:
            return "3270_FieldMark";
            break;
        case XK_3270_Right2:
            return "3270_Right2";
            break;
        ...
        case XK_3270_EraseEOF:
            return "3270_EraseEOF";
            break;
        case XK_3270_EraseInput:
            return "3270_EraseInput";
            break;
        case XK_3270_Reset:
            return "3270_Reset";
            break;
        ...
        case XK_3270_Attn:
            return "3270_Attn";
            break;
        case XK_3270_CursorBlink:
            return "3270_CursorBlink";
            break;
        case XK_3270_AltCursor:
            return "3270_AltCursor";
            break;
        case XK_3270_KeyClick:
            return "3270_KeyClick";
            break;
        case XK_3270_Jump:
            return "3270_Jump";
            break;
        ...
        case XK_3270_Record:
            return "3270_Record";
            break;
        case XK_3270_ChangeScreen:
            return "3270_ChangeScreen";
            break;
        case XK_3270_DeleteWord:
            return "3270_DeleteWord";
            break;
        case XK_3270_ExSelect:
            return "3270_ExSelect";
            break;
        case XK_3270_CursorSelect:
            return "3270_CursorSelect";
            break;
        case XK_3270_PrintScreen:
            return "3270_PrintScreen";
            break;
        case XK_3270_Enter:
            return "3270_Enter";
            break;
        ...
        case XK_Arabic_percent:
            return "Arabic_percent";
            break;
        case XK_Arabic_superscript_alef:
            return "Arabic_superscript_alef";
            break;
        case XK_Arabic_tteh:
            return "Arabic_tteh";
            break;
        ...
        case XK_Arabic_madda_above:
            return "Arabic_madda_above";
            break;
        case XK_Arabic_hamza_above:
            return "Arabic_hamza_above";
            break;
        case XK_Arabic_hamza_below:
            return "Arabic_hamza_below";
            break;
        case XK_Arabic_jeh:
            return "Arabic_jeh";
            break;
        ...
        case XK_Arabic_noon_ghunna:
            return "Arabic_noon_ghunna";
            break;
        case XK_Arabic_heh_doachashmee:
            return "Arabic_heh_doachashmee";
            break;
        case XK_Farsi_yeh:
            return "Farsi_yeh";
            break;
        case XK_Arabic_yeh_baree:
            return "Arabic_yeh_baree";
            break;
        case XK_Arabic_heh_goal:
            return "Arabic_heh_goal";
            break;
        case XK_Cyrillic_GHE_bar:
            return "Cyrillic_GHE_bar";
            break;
        case XK_Cyrillic_ghe_bar:
            return "Cyrillic_ghe_bar";
            break;
        case XK_Cyrillic_ZHE_descender:
            return "Cyrillic_ZHE_descender";
            break;
        case XK_Cyrillic_zhe_descender:
            return "Cyrillic_zhe_descender";
            break;
        case XK_Cyrillic_KA_descender:
            return "Cyrillic_KA_descender";
            break;
        case XK_Cyrillic_ka_descender:
            return "Cyrillic_ka_descender";
            break;
        case XK_Cyrillic_KA_vertstroke:
            return "Cyrillic_KA_vertstroke";
            break;
        case XK_Cyrillic_ka_vertstroke:
            return "Cyrillic_ka_vertstroke";
            break;
        case XK_Cyrillic_EN_descender:
            return "Cyrillic_EN_descender";
            break;
        case XK_Cyrillic_en_descender:
            return "Cyrillic_en_descender";
            break;
        case XK_Cyrillic_U_straight:
            return "Cyrillic_U_straight";
            break;
        case XK_Cyrillic_u_straight:
            return "Cyrillic_u_straight";
            break;
        case XK_Cyrillic_U_straight_bar:
            return "Cyrillic_U_straight_bar";
            break;
        case XK_Cyrillic_u_straight_bar:
            return "Cyrillic_u_straight_bar";
            break;
        case XK_Cyrillic_HA_descender:
            return "Cyrillic_HA_descender";
            break;
        case XK_Cyrillic_ha_descender:
            return "Cyrillic_ha_descender";
            break;
        case XK_Cyrillic_CHE_descender:
            return "Cyrillic_CHE_descender";
            break;
        case XK_Cyrillic_che_descender:
            return "Cyrillic_che_descender";
            break;
        case XK_Cyrillic_CHE_vertstroke:
            return "Cyrillic_CHE_vertstroke";
            break;
        case XK_Cyrillic_che_vertstroke:
            return "Cyrillic_che_vertstroke";
            break;
        case XK_Cyrillic_SHHA:
            return "Cyrillic_SHHA";
            break;
        case XK_Cyrillic_shha:
            return "Cyrillic_shha";
            break;
        case XK_Cyrillic_SCHWA:
            return "Cyrillic_SCHWA";
            break;
        case XK_Cyrillic_schwa:
            return "Cyrillic_schwa";
            break;
        case XK_Cyrillic_I_macron:
            return "Cyrillic_I_macron";
            break;
        case XK_Cyrillic_i_macron:
            return "Cyrillic_i_macron";
            break;
        case XK_Cyrillic_O_bar:
            return "Cyrillic_O_bar";
            break;
        case XK_Cyrillic_o_bar:
            return "Cyrillic_o_bar";
            break;
        case XK_Cyrillic_U_macron:
            return "Cyrillic_U_macron";
            break;
        case XK_Cyrillic_u_macron:
            return "Cyrillic_u_macron";
            break;
        ...
        case XK_Thai_phinthu:
            return "Thai_phinthu";
            break;
        case XK_Thai_maihanakat_maitho:
        ...
        case XK_Hangul_Jamo:
            return "Hangul_Jamo";
            break;
        case XK_Hangul_Romaja:
            return "Hangul_Romaja";
            break;
        case XK_Hangul_Jeonja:
            return "Hangul_Jeonja";
            break;
        case XK_Hangul_Banja:
            return "Hangul_Banja";
            break;
        case XK_Hangul_PreHanja:
            return "Hangul_PreHanja";
            break;
        case XK_Hangul_PostHanja:
            return "Hangul_PostHanja";
            break;
        case XK_Hangul_Special:
            return "Hangul_Special";
            break;
        case XK_Hangul_Kiyeog:
            return "Hangul_Kiyeog";
            break;
        case XK_Hangul_SsangKiyeog:
            return "Hangul_SsangKiyeog";
            break;
        case XK_Hangul_KiyeogSios:
            return "Hangul_KiyeogSios";
            break;
        case XK_Hangul_Nieun:
            return "Hangul_Nieun";
            break;
        case XK_Hangul_NieunJieuj:
            return "Hangul_NieunJieuj";
            break;
        case XK_Hangul_NieunHieuh:
            return "Hangul_NieunHieuh";
            break;
        case XK_Hangul_Dikeud:
            return "Hangul_Dikeud";
            break;
        case XK_Hangul_SsangDikeud:
            return "Hangul_SsangDikeud";
            break;
        case XK_Hangul_Rieul:
            return "Hangul_Rieul";
            break;
        case XK_Hangul_RieulKiyeog:
            return "Hangul_RieulKiyeog";
            break;
        case XK_Hangul_RieulMieum:
            return "Hangul_RieulMieum";
            break;
        case XK_Hangul_RieulPieub:
            return "Hangul_RieulPieub";
            break;
        case XK_Hangul_RieulSios:
            return "Hangul_RieulSios";
            break;
        case XK_Hangul_RieulTieut:
            return "Hangul_RieulTieut";
            break;
        case XK_Hangul_RieulPhieuf:
            return "Hangul_RieulPhieuf";
            break;
        case XK_Hangul_RieulHieuh:
            return "Hangul_RieulHieuh";
            break;
        case XK_Hangul_Mieum:
            return "Hangul_Mieum";
            break;
        case XK_Hangul_Pieub:
            return "Hangul_Pieub";
            break;
        case XK_Hangul_SsangPieub:
            return "Hangul_SsangPieub";
            break;
        case XK_Hangul_PieubSios:
            return "Hangul_PieubSios";
            break;
        case XK_Hangul_Sios:
            return "Hangul_Sios";
            break;
        case XK_Hangul_SsangSios:
            return "Hangul_SsangSios";
            break;
        case XK_Hangul_Ieung:
            return "Hangul_Ieung";
            break;
        case XK_Hangul_Jieuj:
            return "Hangul_Jieuj";
            break;
        case XK_Hangul_SsangJieuj:
            return "Hangul_SsangJieuj";
            break;
        case XK_Hangul_Cieuc:
            return "Hangul_Cieuc";
            break;
        case XK_Hangul_Khieuq:
            return "Hangul_Khieuq";
            break;
        case XK_Hangul_Tieut:
            return "Hangul_Tieut";
            break;
        case XK_Hangul_Phieuf:
            return "Hangul_Phieuf";
            break;
        case XK_Hangul_Hieuh:
            return "Hangul_Hieuh";
            break;
        case XK_Hangul_A:
            return "Hangul_A";
        ...
        case XK_Armenian_ligature_ew:
            return "Armenian_ligature_ew";
            break;
        case XK_Armenian_full_stop:
            return "Armenian_full_stop";
            break;
        case XK_Armenian_separation_mark:
            return "Armenian_separation_mark";
            break;
        case XK_Armenian_hyphen:
            return "Armenian_hyphen";
            break;
        case XK_Armenian_exclam:
            return "Armenian_exclam";
            break;
        case XK_Armenian_accent:
            return "Armenian_accent";
            break;
        case XK_Armenian_question:
            return "Armenian_question";
            break;
        ...
        case XK_Armenian_GHAT:
            return "Armenian_GHAT";
            break;
        case XK_Armenian_ghat:
            return "Armenian_ghat";
            break;
        case XK_Armenian_TCHE:
            return "Armenian_TCHE";
            break;
        case XK_Armenian_tche:
            return "Armenian_tche";
            break;
        ...
        case XK_Armenian_VYUN:
            return "Armenian_VYUN";
            break;
        case XK_Armenian_vyun:
            return "Armenian_vyun";
            break;
        case XK_Armenian_PYUR:
            return "Armenian_PYUR";
            break;
        case XK_Armenian_pyur:
            return "Armenian_pyur";
            break;
        ...
        case XK_Acircumflexacute:
            return "Acircumflexacute";
            break;
        case XK_acircumflexacute:
            return "acircumflexacute";
            break;
        case XK_Acircumflexgrave:
            return "Acircumflexgrave";
            break;
        case XK_acircumflexgrave:
            return "acircumflexgrave";
            break;
        case XK_Acircumflexhook:
            return "Acircumflexhook";
            break;
        case XK_acircumflexhook:
            return "acircumflexhook";
            break;
        case XK_Acircumflextilde:
            return "Acircumflextilde";
            break;
        case XK_acircumflextilde:
            return "acircumflextilde";
            break;
        case XK_Acircumflexbelowdot:
            return "Acircumflexbelowdot";
            break;
        case XK_acircumflexbelowdot:
            return "acircumflexbelowdot";
            break;
        ...
        case XK_Ecircumflexacute:
            return "Ecircumflexacute";
            break;
        case XK_ecircumflexacute:
            return "ecircumflexacute";
            break;
        case XK_Ecircumflexgrave:
            return "Ecircumflexgrave";
            break;
        case XK_ecircumflexgrave:
            return "ecircumflexgrave";
            break;
        case XK_Ecircumflexhook:
            return "Ecircumflexhook";
            break;
        case XK_ecircumflexhook:
            return "ecircumflexhook";
            break;
        case XK_Ecircumflextilde:
            return "Ecircumflextilde";
            break;
        case XK_ecircumflextilde:
            return "ecircumflextilde";
            break;
        case XK_Ecircumflexbelowdot:
            return "Ecircumflexbelowdot";
            break;
        case XK_ecircumflexbelowdot:
            return "ecircumflexbelowdot";
            break;
        ...
        case XK_Ocircumflexacute:
            return "Ocircumflexacute";
            break;
        case XK_ocircumflexacute:
            return "ocircumflexacute";
            break;
        case XK_Ocircumflexgrave:
            return "Ocircumflexgrave";
            break;
        case XK_ocircumflexgrave:
            return "ocircumflexgrave";
            break;
        case XK_Ocircumflexhook:
            return "Ocircumflexhook";
            break;
        case XK_ocircumflexhook:
            return "ocircumflexhook";
            break;
        case XK_Ocircumflextilde:
            return "Ocircumflextilde";
            break;
        case XK_ocircumflextilde:
            return "ocircumflextilde";
            break;
        case XK_Ocircumflexbelowdot:
            return "Ocircumflexbelowdot";
            break;
        case XK_ocircumflexbelowdot:
            return "ocircumflexbelowdot";
            break;
        ...
        case XK_uhorn:
            return "uhorn";
            break;
        case XK_combining_tilde:
            return "combining_tilde";
            break;
        case XK_combining_grave:
            return "combining_grave";
            break;
        case XK_combining_acute:
            return "combining_acute";
            break;
        case XK_combining_hook:
            return "combining_hook";
            break;
        case XK_combining_belowdot:
            return "combining_belowdot";
            break;
        case XK_EcuSign:
            return "EcuSign";
            break;
        ...
        case XK_stricteq:
            return "stricteq";
            break;
        case XK_braille_dot_1:
            return "braille_dot_1";
            break;
        case XK_braille_dot_2:
            return "braille_dot_2";
            break;
        case XK_braille_dot_3:
            return "braille_dot_3";
            break;
        case XK_braille_dot_4:
            return "braille_dot_4";
            break;
        case XK_braille_dot_5:
            return "braille_dot_5";
            break;
        case XK_braille_dot_6:
            return "braille_dot_6";
            break;
        case XK_braille_dot_7:
            return "braille_dot_7";
            break;
        case XK_braille_dot_8:
            return "braille_dot_8";
            break;
        case XK_braille_dot_9:
            return "braille_dot_9";
            break;
        case XK_braille_dot_10:
