...
set CommonCompilerFlags=-MTd -Gm- -nologo -GR- -EHa- -Oi -FC -Z7 -WX -W4 -wd4459 -wd4456 -wd4201 -wd4100 -wd4101 -wd4189 -wd4505 -wd4996 -wd4389 -wd4244 -wd4702 -wd5287 -I..\source -std:c++20 -Zc:strictStrings-

cl %CommonCompilerFlags% -DEDITOR_INTERNAL=1 -Fecling.exe -Fmcling.map ..\source\cling\cling.c /link %CommonLinkerFlags%
