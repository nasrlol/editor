...
internal void
UI_PushBackgroundColor(v4 BackgroundColor)
{
    UI_StackPush(v4, BackgroundColor);
}
internal void
UI_PopBackgroundColor()
{
    UI_StackPop(BackgroundColor);
}

internal void
UI_PushTextColor(v4 TextColor)
{
    UI_StackPush(v4, TextColor);
}
internal void
UI_PopTextColor()
{
    UI_StackPop(TextColor);
}

internal void
UI_PushBorderColor(v4 BorderColor)
{
    UI_StackPush(v4, BorderColor);
}
internal void
UI_PopBorderColor()
{
    UI_StackPop(BorderColor);
}

internal void
UI_PushBorderThickness(f32 BorderThickness)
{
    UI_StackPush(f32, BorderThickness);
}
internal void
UI_PopBorderThickness()
{
    UI_StackPop(BorderThickness);
}

internal void
UI_PushSoftness(f32 Softness)
{
    UI_StackPush(f32, Softness);
}
internal void
UI_PopSoftness()
{
    UI_StackPop(Softness);
}

internal void
UI_PushCornerRadii(v4 CornerRadii)
{
    UI_StackPush(v4, CornerRadii);
}
internal void
UI_PopCornerRadii()
{
    UI_StackPop(CornerRadii);
}

internal void
UI_PushLayoutAxis(axis2 LayoutAxis)
{
    UI_StackPush(axis2, LayoutAxis);
}
internal void
UI_PopLayoutAxis()
{
    UI_StackPop(LayoutAxis);
}

internal void
UI_PushSemanticWidth(ui_size SemanticWidth)
{
    UI_StackPush(ui_size, SemanticWidth);
}
internal void
UI_PopSemanticWidth()
{
    UI_StackPop(SemanticWidth);
}

internal void
UI_PushSemanticHeight(ui_size SemanticHeight)
{
